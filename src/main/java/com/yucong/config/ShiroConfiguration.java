...
public class ShiroConfiguration {
	...
	private String host = "r-uf6tknbhr9hzsfyzukpd.redis.rds.aliyuncs.com";
    // @Value("${shiro.redis.port}")
    private int port = 6379;
    // @Value("${shiro.redis.timeout}")
    private int timeout = 6000;
    // @Value("${shiro.redis.password}")
    private String password = "LaiTest@2020";
    ...
    /**
     * <p>加密器：这样一来数据库就可以是密文存储，为了演示我就不开启了
     */
    @Bean
    ...
    /**
     * <p> 自定义sessionManager
     * <p>参考：https://blog.csdn.net/u013615903/article/details/78781166
     */
    @Bean
    ...
    /**
     * <p>只是一个例子，因为我们在这里可以用这样的方式获取到相关访问数据库的对象，
     * <p>然后读取数据库相关配置，配置到 shiroFilterFactoryBean 的访问规则中。实际项目中，请使用自己的Service来处理业务逻辑。
     */
    ...
    /**
     * <p>加载shiroFilter权限控制规则（从数据库读取然后配置）
     */
