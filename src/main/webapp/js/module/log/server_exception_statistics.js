    ...
    $.module("Log.serverException", function () {
        ...
        return {
            ...
            loadData: function (pageNumber, pageSize) {
                ...
                SYS.Core.ajaxGet({
                    url: "logStatistics/listServerExceptionStatistics",
                    data: {
                    ...
                    success: function (data) {
                        ...
                        $('#myTable').bootstrapTable({               //重新生成table
                            ...
                            columns: [
                                ...
                                { field: 'num', title: '出现次数', align: 'center'  },
                                { field: 'attackNum', title: '攻击次数', align: 'center'  },
                                {
                                ...
                                {
                                    field: 'updateTime', title: '最后一次发生时间', align: 'center',
